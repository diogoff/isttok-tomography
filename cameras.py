...
# b_pinhole_x = 5. + 102 * np.cos(np.radians(-82.5))    ***UNCOMMENT TO ADD BOTTOM CAMERA***
...
# print('b_pinhole_x:', b_pinhole_x)    ***UNCOMMENT TO ADD BOTTOM CAMERA***
...
f_dist = 9.
# b_dist = 13.  ***UNCOMMENT TO ADD BOTTOM CAMERA***

t_theta = np.pi                 # Top: rotated 180deg (upside down)
f_theta = np.pi / 2.            # Front: vertical on the LFS (facing left) 90deg
# b_theta = np.pi * 7.5 / 180.    # Bottom: looking up at slight positive angle 7.5deg  ***UNCOMMENT TO ADD BOTTOM CAMERA***
...
# print('b_detector_x:', b_detector_x)  ***UNCOMMENT TO ADD BOTTOM CAMERA***
...
# for i in range(n):                ***UNCOMMENT TO ADD BOTTOM CAMERA***
#     x0 = b_detector_x[i]
#     y0 = b_detector_y[i]
#     x1 = b_pinhole_x
#     y1 = b_pinhole_y
