...
The code is based on the 3-camera setup described in P. J. Carvalho's [PhD thesis](http://bibliotecas.utl.pt/cgi-bin/koha/opac-detail.pl?biblionumber=428085).
